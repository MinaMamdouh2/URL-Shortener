...
// Middleware is a handler function designed to run code before and/or after another Handler.
// It is designed to remove boilerplate or other concerns not direct to any given app Handler.
